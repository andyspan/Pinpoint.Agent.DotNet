...
SqlCommand_ExecuteReader::SqlCommand_ExecuteReader(ICorProfilerInfo *corProfilerInfo)
	:Interceptor(corProfilerInfo)
{

}

WCHAR *SqlCommand_ExecuteReader::GetClassName2()
{
	return L"System.Data.SqlClient.SqlCommand";
}

WCHAR *SqlCommand_ExecuteReader::GetMethodName()
{
